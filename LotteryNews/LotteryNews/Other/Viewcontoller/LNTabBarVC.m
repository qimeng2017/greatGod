...
- (void)viewDidLoad {
    ...
    HandpickRankListViewController *vc4 = [[HandpickRankListViewController alloc] init];
    ...
    [self addChildViewController:vc3 withImage:[UIImage imageNamed:@"tabbar_3"] selectedImage:[UIImage imageNamed:@"tabbar_3_hl"] withTittle:@"资料"];
